import{_ as i}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,f as s,a as e,e as r}from"./app-LDsfaBLG.js";const l="/images/article/181212/observable.png",d="/images/article/181212/res1.png",t={},v=e("blockquote",null,[e("p",null,"观察模式，提供了一种实时监听方案。定义对象间的一种一对多的依赖关系，当一个对象的状态发生改变时，所有依赖于它的对象都得到通知并被自动更新。[菜鸟]")],-1),c=r(`<p>当我们的流水线，每生产一辆车，我们都要记录并检验这辆车。<br> 这里的记录员和质检员就是观察者。生产线则是被观察者。当被观察者变化时，就要通知其依赖的这些记录员和质检员。</p><h2 id="被观察者" tabindex="-1"><a class="header-anchor" href="#被观察者" aria-hidden="true">#</a> 被观察者</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package observer;

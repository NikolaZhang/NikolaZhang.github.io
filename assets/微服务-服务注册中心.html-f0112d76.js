import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as t,f as l,a as e,e as d}from"./app-496bc06f.js";const s="/images/article/181201/configspringboot.png",r="/images/article/181201/ds.png",a={},v=e("blockquote",null,[e("p",null,"从今天开始微服务的搭建就正式开始了。")],-1),c=d('<h1 id="服务注册中心" tabindex="-1"><a class="header-anchor" href="#服务注册中心" aria-hidden="true">#</a> 服务注册中心</h1><h2 id="创建工程" tabindex="-1"><a class="header-anchor" href="#创建工程" aria-hidden="true">#</a> 创建工程</h2><p>首先我们要创建一个springboot工程，使用自动创建的方式。需要选择eurekaserver <img src="'+s+`" alt="选择eurekaserver"></p><p>生成pom文件如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以上我们的注册服务中心就构建完成了。 现在我们要再搭建一个注册服务，构建一个注册服务的集群。 为了方便，我们只需要重新建一个yml配置文件，并在启动配置中设置启动参数即可。 新建的yml如下</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>spring:
  application:
    name: eureka-server
server:
  port: 1112

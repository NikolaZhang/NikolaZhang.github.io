...
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),f={start:"5"},_={href:"http://localhost:9000/turbine.stream",target:"_blank",rel:"noopener noreferrer"},y=e("h3",{id:"end",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#end","aria-hidden":"true"},"#"),i(" end")],-1),I=e("p",null,"到此为止，服务容错已经介绍完毕，这周末我会把之前的程序测试一下，然后再水一篇博客。",-1);function k(H,w){const t=d("ExternalLinkIcon");return l(),s("div",null,[u,o("more"),v,e("p",null,[e("a",b,[i("http://ip"),n(t)]),i(":port/hystrix"),p,i(" 从页面上我们可以看到，HystrixDashboard支持三种不同的监控方式：")]),g,e("ol",m,[e("li",null,[i("在浏览器中输入"),e("a",h,[i("http://localhost:9000/turbine.stream"),n(t)])])]),x,e("ol",f,[e("li",null,[i("验证输入"),e("a",_,[i("http://localhost:9000/turbine.stream"),n(t)]),i(". 效果同上, 但是这里的监控信息是通过消息代理异步获取之后输出到Hystrix Dashboard中的.")])]),y,I])}const q=a(c,[["render",k],["__file","仪表盘.html.vue"]]);export{q as default};

...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="命令模块" tabindex="-1"><a class="header-anchor" href="#命令模块" aria-hidden="true">#</a> 命令模块</h2><p>命令模块更具输入的命令，调用对应的模块执行命令<br> 同样为了易于扩展我们将其做成一个抽象类。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package command;

import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as s,f as l,a as e,e as d}from"./app-NrCyFU9E.js";const a="/images/article/181215/res1.png",r={},v=e("blockquote",null,[e("p",null,"解释器模式，最经典的解释器模型就是我们用的那些IDE。将你编写的语言转成机器语言。这个转换就可以理解为解释。")],-1),t=d(`<h2 id="模型结构" tabindex="-1"><a class="header-anchor" href="#模型结构" aria-hidden="true">#</a> 模型结构</h2><p>解释器模型，有三个主要的角色。</p><ol><li>Context：环境角色，主要用于存放传入的数据。</li><li>AbstractExpress：抽象解释器，是所有解释器的接口或者抽象父类。</li><li>TerminalExpress：终结符表达式，主要解释文法。</li><li>NonTermianlExpress: 非终结符表达式，主要解释符号标记。<br> 比如：select * from database where name = #{name}<br> select，from，where [a-z_A-Z]* =,是非终结表达式。database,*，#{name}这样的就属于终结表达式。<br> 下面看看我这个例子吧。笑笑就好~实在拙劣。。。</li></ol><h2 id="环境角色" tabindex="-1"><a class="header-anchor" href="#环境角色" aria-hidden="true">#</a> 环境角色</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package interpretor;

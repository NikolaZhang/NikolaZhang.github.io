import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,e as t}from"./app-CYrfdzXE.js";const o={};function p(i,n){return a(),e("div",null,n[0]||(n[0]=[t(`<h2 id="查询" tabindex="-1"><a class="header-anchor" href="#查询" aria-hidden="true">#</a> 查询</h2><ol><li>查询使用的是GET方式, 比如查询id为1的员工.</li></ol><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>GET /megacorp/employee/<span class="token number">1</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://tech.nikolazhang.top/2020-02-01-13-45-39.png" alt="2020-02-01-13-45-39"><br> 2. 搜索全部</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>GET /megacorp/employee/_search
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://tech.nikolazhang.top/2020-02-01-13-49-44.png" alt="2020-02-01-13-49-44"></p><p>响应内容的hits数组中包含了我们所有的三个文档。默认情况下搜索会返回前10个结果。<br> 3. 根据字段值查询<br> 查询last_name包含Smith的员工. 此时仍然使用_search关键词进行查询, 但是需要在请求中添加参数q, 其值为一个键值对, 相当于sql中的条件.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>GET /megacorp/employee/_search?q=last_name<span class="token operator">:</span>Smith
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://tech.nikolazhang.top/2020-02-01-13-53-46.png" alt="2020-02-01-13-53-46"></p><p>可以看到出现了两个匹配结果<br> 4. 查询部分字段</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>GET /megacorp/employee/<span class="token number">1</span>?_source=first_name<span class="token punctuation">,</span>last_name
...
<span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://tech.nikolazhang.top/2020-02-01-15-13-49.png" alt="2020-02-01-15-13-49"></p>`,41)]))}const r=s(o,[["render",p],["__file","elasticsearch系列_5_入门-查询.html.vue"]]);export{r as default};

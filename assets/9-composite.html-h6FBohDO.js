import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as s,f as d,a as e,e as t}from"./app-Y4FVIHIl.js";const a="/images/article/181211/res1.png",l="/images/article/181211/res2.png",v={},c=e("blockquote",null,[e("p",null,"组合模式，适用于树状结构。模式有三个角色：组合部件，合成模块，叶子。组合部件是组合其余两者的父类。它是一个提供公共属性，方法的抽象类。合成模块用于合成最终的组合对象，叶子节点是组合部件的底层，也就相当于树枝与树叶。该模式又为安全模式和透明模式。两者却别在于父类是否提供用于合成组件的所有方法。")],-1),o=t(`<p>好了，我们的公司最近招人。那么就以人事的结构为例吧。<br> 首先zhangxu是这个虚拟公司的BOSS。下面有两个经理：lisi,wangwu。还有几个招聘的小弟。</p><h1 id="_1-透明模式" tabindex="-1"><a class="header-anchor" href="#_1-透明模式" aria-hidden="true">#</a> 1 透明模式：</h1><h2 id="_1-2-抽象组合部件" tabindex="-1"><a class="header-anchor" href="#_1-2-抽象组合部件" aria-hidden="true">#</a> 1.2 抽象组合部件</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package composite.compositiontransparent;

import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as l,a as n,f as d,e as r}from"./app-CYrfdzXE.js";const s="/images/article/181201/configspringboot.png",a="/images/article/181201/ds.png",v={};function c(g,e){return t(),l("div",null,[e[0]||(e[0]=n("blockquote",null,[n("p",null,"从今天开始微服务的搭建就正式开始了。")],-1)),d("more"),e[1]||(e[1]=r('<h1 id="服务注册中心" tabindex="-1"><a class="header-anchor" href="#服务注册中心" aria-hidden="true">#</a> 服务注册中心</h1><h2 id="创建工程" tabindex="-1"><a class="header-anchor" href="#创建工程" aria-hidden="true">#</a> 创建工程</h2><p>首先我们要创建一个springboot工程，使用自动创建的方式。需要选择eurekaserver<br><img src="'+s+`" alt="选择eurekaserver"></p><p>生成pom文件如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这里我们向peer1和peer2中注册我们的服务。</p><h2 id="启动测试" tabindex="-1"><a class="header-anchor" href="#启动测试" aria-hidden="true">#</a> 启动测试</h2><p>项目启动后我们会在浏览器中看到Instances currently registered with Eureka中出现了我们的服务。<br> 而且在注册服务器的控制台中会有<code>Registered instance BOOKSERVICE/ZHANGXU:bookservice:8080 with status UP (replication=false)</code>显示。</p>`,29))])}const m=i(v,[["render",c],["__file","微服务-服务注册中心.html.vue"]]);export{m as default};

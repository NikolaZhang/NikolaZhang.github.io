...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8)),t("p",null,[e[7]||(e[7]=l("链接：")),t("a",g,[e[6]||(e[6]=l("视图")),r(d)])]),e[14]||(e[14]=n(`<h3 id="_1-3-7-触发器" tabindex="-1"><a class="header-anchor" href="#_1-3-7-触发器" aria-hidden="true">#</a> 1.3.7 触发器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create trigger worktrigger on worker
after delete as
begin
...
drop table temp;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15))])}const p=a(o,[["render",f],["__file","SqlServer-数据库相关操作.html.vue"]]);export{p as default};

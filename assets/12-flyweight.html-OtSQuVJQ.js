import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as a,f as s,a as i,e as l}from"./app-gcBkGn6F.js";const d="/images/article/181215/res2.png",r={},v=i("blockquote",null,[i("p",null,"享元模式：主要用于减少创建对象的数量，以减少内存占用和提高性能。这种类型的设计模式属于结构型模式，它提供了减少对象数量从而改善应用所需的对象结构的方式。【菜鸟】")],-1),t=l(`<p>这个模式也比较简单。比如我们要生产相同型号，但涂装不同的宝马。我们生产了黑色宝马后，还有必要再去实例化一个宝马，再去设置它的型号吗？我们是不是直接换一下颜色就可以了？<br> 怎么说呢，你可以理解为直接setColor就生产了另外一辆宝马。</p><p>这里我们为了好看，还是使用工厂去生产宝马，同时呢引入一个map用于存放我们已经生产的不同类型的宝马，当我们需要更换涂装时，直接从map中取出对应的型号，涂一下就好了。</p><h2 id="宝马车长这样" tabindex="-1"><a class="header-anchor" href="#宝马车长这样" aria-hidden="true">#</a> 宝马车长这样</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package flyweight;

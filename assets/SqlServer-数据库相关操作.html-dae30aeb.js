...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8),p={href:"https://www.cnblogs.com/Brambling/p/6731386.html",target:"_blank",rel:"noopener noreferrer"},w=l(`<h3 id="_1-3-7-触发器" tabindex="-1"><a class="header-anchor" href="#_1-3-7-触发器" aria-hidden="true">#</a> 1.3.7 触发器</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>create trigger worktrigger on worker
after delete as
begin
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_1-3-11-其他" tabindex="-1"><a class="header-anchor" href="#_1-3-11-其他" aria-hidden="true">#</a> 1.3.11 其他</h3><blockquote><p><strong>添加、删除字段</strong> alter table info add note1 varchar(100); alter table info drop column note1; <strong>删除表的内容</strong> truncate table worker <strong>查询分页</strong> select top number|percent * from tablename sql server要实现查询从第几条到第几条记录. 可以使用如下方法:</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>-- 查询第6到15条记录
...
drop table temp;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15);function E(k,S){const n=i("ExternalLinkIcon");return r(),s("div",null,[v,u,c("more"),m,e("p",null,[e("a",b,[t("【SqlServer】Sql Server 支持的数据类型"),d(n)])]),g,e("blockquote",null,[e("p",null,[h,e("a",f,[t("datename和datepart的使用"),d(n)])])]),x,e("p",null,[t("链接: "),e("a",y,[t("关于索引的高级使用"),d(n)])]),_,e("p",null,[t("链接："),e("a",p,[t("视图"),d(n)])]),w])}const O=a(o,[["render",E],["__file","SqlServer-数据库相关操作.html.vue"]]);export{O as default};

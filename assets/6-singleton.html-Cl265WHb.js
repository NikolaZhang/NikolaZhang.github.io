import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,e as t}from"./app-CYrfdzXE.js";const p="/assets/image-zT4J3yWv.png",c={};function o(l,n){return a(),e("div",null,n[0]||(n[0]=[t('<blockquote><p>单例模式，确保一个类只有一个实例，并且提供了对该类的全局访问入口，它可以确保使用这个类实例的所有对象都使用相同的实例。</p></blockquote><p><img src="'+p+`" alt="Alt text"></p><h2 id="单例模式-懒汉模式" tabindex="-1"><a class="header-anchor" href="#单例模式-懒汉模式" aria-hidden="true">#</a> 单例模式-懒汉模式</h2><p>在需要的时候才创建实例，并且只创建一次。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SingletonA</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>加锁之后，还要进行判空，目的是为了防止其他线程创建类实例后，当前线程又再次创建。</p>`,15)]))}const d=s(c,[["render",o],["__file","6-singleton.html.vue"]]);export{d as default};

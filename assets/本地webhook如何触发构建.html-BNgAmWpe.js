...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当消息正常发送，并收到请求结果，则说明脚本可以正常运行。</p><p><img src="`+l+'" alt="Alt text"></p><p>这样以后我们向远程push代码时，本地git就会触发hook，给内网的Jenkins发送构建请求。</p>',27),u=[r];function d(v,m){return n(),a("div",null,u)}const q=s(c,[["render",d],["__file","本地webhook如何触发构建.html.vue"]]);export{q as default};

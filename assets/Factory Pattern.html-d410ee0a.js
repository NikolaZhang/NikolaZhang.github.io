import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as l,f as s,a as i,e as a}from"./app-2cb008ec.js";const d={},r=i("blockquote",null,[i("p",null,"又称为静态工厂模式，提供一个公有的静态工厂方法，返回一个类的实例。 通过工厂我们不必具体去实例化某一个实例对象。只需要传递某些约定的参数，工厂会自动找到该类并将其实例化。")],-1),c=a(`<ol><li>创建一个接口，接口中定义公用方法。</li></ol><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>package factory.simplefactory;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="5"><li>说明 在工厂类中我们使用反射生成对应的实例对象。需要的参数为实体的路径。 当某天我们的系统需要进行扩展时，仅仅需要添加一个实体，并实现接口中的方法。 而我们的工厂方法则不会有什么需要改动的地方。</li></ol>`,9);function v(t,u){return n(),l("div",null,[r,s("more"),c])}const b=e(d,[["render",v],["__file","Factory Pattern.html.vue"]]);export{b as default};

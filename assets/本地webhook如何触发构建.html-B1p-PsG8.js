import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as e,e as t}from"./app-CYrfdzXE.js";const o="/assets/image-2-BqKfqSJx.png",i="/assets/image-3-BSSpA9QE.png",p="/assets/image-4-BGVay6rV.png",l="/assets/image-11-D4CLq4Ob.png",c="/assets/image-10-CIEU0JHi.png",r={};function u(d,s){return a(),e("div",null,s[0]||(s[0]=[t('<blockquote><p>使用gitee触发webhook需要外网地址，我们只有内网环境，那么本地如何触发构建呢？这篇文章尝试通过本地添加git hook脚本，在提交之后发送构建请求。</p></blockquote><h2 id="gitee中的webhook" tabindex="-1"><a class="header-anchor" href="#gitee中的webhook" aria-hidden="true">#</a> gitee中的webhook</h2><p>打开项目中的管理菜单，可以找到WebHooks。</p><p><img src="'+o+'" alt="Alt text"></p><p>上图中的账号密码为Jenkins用户的账号密码。</p><p>尝试发送一个请求，看看请求的格式，之后通过本地发送请求触发构建。</p><p><img src="'+i+'" alt="Alt text"></p><h2 id="本地模拟hook请求" tabindex="-1"><a class="header-anchor" href="#本地模拟hook请求" aria-hidden="true">#</a> 本地模拟hook请求</h2><p>请求地址、header、body复制到postman中。</p><p><img src="'+p+`" alt="Alt text"></p><p>之后删除一些属性，发送请求。经过简化，我们发送信息需要包含下面的部分即可。</p><p>header需要包含的内容：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>X-Git-Oschina-Event: Push Hook
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>脚本中url需要改为Jenkins提示中的url。</p><p><img src="`+l+`" alt="Alt text"></p><p>打开git bash终端，测试脚本是否可以正常运行。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">cat</span> pre-push <span class="token operator">|</span> <span class="token function">bash</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当消息正常发送，并收到请求结果，则说明脚本可以正常运行。</p><p><img src="`+c+'" alt="Alt text"></p><p>这样以后我们向远程push代码时，本地git就会触发hook，给内网的Jenkins发送构建请求。</p>',27)]))}const k=n(r,[["render",u],["__file","本地webhook如何触发构建.html.vue"]]);export{k as default};
